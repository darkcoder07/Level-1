...
public class BackPack {
	...
	public static void main(String[] args) {
		...
		BackPack manbag = new BackPack();
		Pencil No2 = new Pencil();
		Ruler Mrcentimeter = new Ruler();
		Textbook bigbook = new Textbook();
		manbag.putInBackpack(No2);
		manbag.putInBackpack(Mrcentimeter);
		manbag.putInBackpack(bigbook);
		manbag.goToSchool();
		BackPack flappack = new BackPack();
		flappack.goToSchool();
