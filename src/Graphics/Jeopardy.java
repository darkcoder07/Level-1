...
public class Jeopardy implements ActionListener {
	...
	String astronomyq1 = JOptionPane.showInputDialog(null, "What is the belt beyond Neptune? ");
	int score = 0;
...
frame.setTitle("Super Hard Jeopardy");
		
		// 3. Create a JPanel variable to hold the header using the createHeader method
 JPanel header = createHeader("OMG GAME TOO HARD");
...
quizPanel.add(firstButton);		
	...
	fifthButton = createButton("10,000,000,000$");
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton q200$ = new JButton();
		// Set the text of the button to the dollarAmount
	q200$.setText(dollarAmount);
		// Increment the buttonCount (this should make the layout vertical)
	buttonCount++;
		// Return your new button instead of the temporary button
		
		return new JButton("sickbutton");
	}
...
playJeopardyTheme();
		...
		if (buttonPressed.equals(firstButton)) {
			...
			askQuestion(astronomyq1, "The Kepler Belt", 200);
			}
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("What is the ergosphere", "The area where nothing can stop moving near a black hole", 400);
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (astronomyq1.equalsIgnoreCase("Kepler Belt")||astronomyq1.equalsIgnoreCase("The Kepler Belt")) {
		...
		// Otherwise
			...
			JOptionPane.showMessageDialog(null, "Wrong! The correct message was: The Kepler Belt ");
			// Call the updateScore() method
			updateScore();
