...
public class SimonSays extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "computer_key_A.png");
 // 3. Tell the user to "Press the matching key when 'Simon says' otherwise press a different key"
 		JOptionPane.showMessageDialog(null, "Okay. So you must press the key Simon says to cause he is a bully. If it isn't Simon just press a different key.");
	...
	private void showImage() {
     ...
     frame.setSize(100, 94);
	  ...
	  if (random==1) {
		  ...
		  speak("Simone says press this key");
	  }
	}
